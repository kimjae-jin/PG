        ...
        <div class="h-full flex flex-col p-4">
            ...
            <form id="project-form" class="flex-grow overflow-auto space-y-6 pr-2">
                ...
                <section class="form-section">
                    <h4 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">기본 정보</h4>
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                        <div><label class="form-label">계약구분</label><div class="flex items-center space-x-4 pt-2"><label><input type="radio" name="contractType" value="P" class="mr-1" checked> 일반</label><label><input type="radio" name="contractType" value="S" class="mr-1"> 하도급</label></div></div>
                        <div><label class="form-label">구분</label><select name="projectCategory" class="form-select"><option>공공</option><option>민간</option><option>PQ</option><option>공공(하)</option></select></div>
                        <div><label class="form-label">프로젝트넘버</label><input name="projectNumber" class="form-input" placeholder="자동생성 (yyyy-###)"></div>
                        <div><label class="form-label">계약번호</label><input name="contractId" class="form-input"></div>
                    </div>
                </section>
                
                <section class="form-section">
                     <h4 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">계약 상세</h4>
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        <div class="md:col-span-2"><label class="form-label">계약명 *</label><input name="projectName" class="form-input" required></div>
                        <div><label class="form-label">계약자</label><input name="clientName" class="form-input"></div>
                        <div><label class="form-label">총 계약금액</label><input type="text" inputmode="numeric" name="totalAmount" class="form-input text-right"></div>
                        <div><label class="form-label">총 지분금액</label><input type="text" inputmode="numeric" name="totalEquityAmount" class="form-input text-right"></div>
                        <div><label class="form-label">지분율 (%)</label><input type="number" name="equityRatio" class="form-input text-right" readonly></div>
                        <div class="pt-2"><label class="flex items-center"><input type="checkbox" name="vatApplied" class="mr-2 h-4 w-4 rounded"> 부가세 적용</label></div>
                    </div>
                </section>

                <section class="form-section">
                    <h4 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">일정 관리</h4>
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div><label class="form-label">계약일</label><input type="text" name="contractDate" class="form-input" placeholder="yms"></div>
                        <div><label class="form-label">시작일</label><input type="text" name="startDate" class="form-input" placeholder="yms"></div>
                        <div><label class="form-label">완료예정일</label><input type="text" name="endDate" class="form-input" placeholder="yms"></div>
                        <div><label class="form-label">완료일</label><input type="date" name="completionDate" class="form-input"></div>
                    </div>
                </section>

                <section class="form-section">
                    <h4 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">과업 개요</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div><label class="form-label">위치</label><input name="projectLocation" class="form-input"></div>
                        <div><label class="form-label">개요 (70자 이내)</label><input name="summary" class="form-input" maxlength="70"></div>
                    </div>
                </section>
                
                 <section class="form-section">
                     <h4 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">담당자 정보</h4>
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                         <div><label class="form-label">PM (사내 확인용)</label><input name="pmName" class="form-input" placeholder="재직자 중 선택 (구현예정)"></div>
                         <div><label class="form-label">참여기술인</label><div class="p-3 mt-1 border rounded-md bg-gray-200 dark:bg-gray-700 text-gray-500">다음 단계에서 구현됩니다.</div></div>
                    </div>
                </section>

                <section class="form-section">
                     <h4 class="text-lg font-semibold mb-4 text-gray-700 dark:text-gray-300">기타 사항</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                         <div><label class="form-label">특이사항 (자동 기록)</label><textarea name="specialNotes" class="form-textarea h-24" readonly></textarea></div>
                         <div><label class="form-label">비고</label><textarea name="remarks" class="form-textarea h-24"></textarea></div>
                    </div>
                </section>
